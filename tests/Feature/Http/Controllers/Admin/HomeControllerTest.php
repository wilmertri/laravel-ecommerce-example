...
class HomeControllerTest extends TestCase
{
    ...
    /**
     * Test that a user cannot see the admin home page if they are not a super user
     * 
     * @return void 
     */
    ...
    /**
     * Test that ther user is redirected to the login page if they are not logged in.
     * 
     * @return void
     */
